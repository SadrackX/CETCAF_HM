...
if (!(_return)) then
{
	...
	switch (true) do
	{
		...
		case (({_x in _pressedButtonArray} count (actionKeys "MoveForward")) > 0):
		{
			...
			SAT_SatelliteTarget setPos [((getPos SAT_SatelliteTarget) select 0) - SAT_SatelliteNorthMovementDelta,((getPos SAT_SatelliteTarget) select 1) + SAT_SatelliteNorthMovementDelta,(getPos SAT_SatelliteTarget) select 2];
		...
		case (({_x in _pressedButtonArray} count (actionKeys "MoveBack")) > 0):
		{
			...
			SAT_SatelliteTarget setPos [((getPos SAT_SatelliteTarget) select 0) + SAT_SatelliteSouthMovementDelta,((getPos SAT_SatelliteTarget) select 1) - SAT_SatelliteSouthMovementDelta,(getPos SAT_SatelliteTarget) select 2];
			call SAT_updateCamera;
		};
		//case 30://A
		case (({_x in _pressedButtonArray} count (actionKeys "TurnLeft")) > 0):
		{
			...
			SAT_SatelliteTarget setPos [((getPos SAT_SatelliteTarget) select 0) - SAT_SatelliteWestMovementDelta,((getPos SAT_SatelliteTarget) select 1) - SAT_SatelliteWestMovementDelta,(getPos SAT_SatelliteTarget) select 2];
			call SAT_updateCamera;
		};
		//case 32://D
		case (({_x in _pressedButtonArray} count (actionKeys "TurnRight")) > 0):
		{
			...
			SAT_SatelliteTarget setPos [((getPos SAT_SatelliteTarget) select 0) + SAT_SatelliteEastMovementDelta,((getPos SAT_SatelliteTarget) select 1) + SAT_SatelliteEastMovementDelta,(getPos SAT_SatelliteTarget) select 2];
			call SAT_updateCamera;
		};
		//case 78://Num +
